...
const page = () => {
  return (
    <div className="container mx-auto p-2">
      <h1 className="text-2xl font-bold py-4">Privacy Policy</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to budget-traveling.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <b>Website</b> refers to budget-traveling, accessible from{" "}
            <a
              href="https://budget-traveling.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://budget-traveling.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <h2 className="text-2xl font-bold py-4">Children's Privacy</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold py-4">Links to Other Websites</h2>
      <p>
        Our Service may contain links to other websites that are not operated by
        Us. If You click on a third party link, You will be directed to that
        third party's site. We bly advise You to review the Privacy Policy
      ...
      <h2 className="text-2xl font-bold py-4">Changes to this Privacy Policy</h2>
      <p>
      ...
      <ul>
        <li>
          ...
          <a
            ...
            data-cfemail="0a79626b61736b6e6f6f7a786b664a6d676b636624696567"
          >
            [email&#160;protected]
          </a>
        </li>
